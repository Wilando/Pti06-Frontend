...
export async function getServerSideProps(ctx) {
  ...
  if(response.status != 401){
    ...
    var filteredPesanan = await all_pesanan.filter(a => a.status_pesanan == "Belum Selesai");
...
const pesananBelumSelesai = ({data, pesanans, customers}) => {
  const dispatch = useDispatch()

  useEffect(() => {
    dispatch(whoami(data));
    const dataTable = new DataTable("#pesananBelum");
  }, [dispatch])
          ...
          <div className="card mb-4">
            ...
            <div className="card-body">
              <div className="table-responsive">
            	<table className="table" id="pesananBelum">
                  <thead>
                      <tr>
                          <th>Nama Pemesan</th>
                          <th>Tgl Pesanan</th>
